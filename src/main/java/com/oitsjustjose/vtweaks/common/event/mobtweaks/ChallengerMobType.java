...
public enum ChallengerMobType
{
    ...
    { 3, 236, 252 }, null), HUNGRY(0.25D, 40F, "Hungry", new int[]
    { 163, 127, 77 }, new EffectInstance[]
    { new EffectInstance(Effects.HUNGER, 600, 2, false, true) }), RANGER(0.25D, 40F, "Ranger", new int[]
    { 81, 163, 77 }, null), ARCANE(0.25D, 40F, "Arcane", new int[]
    { 63, 10, 92 }, new EffectInstance[]
    { new EffectInstance(Effects.BLINDNESS, 400, 0, false, true),
            new EffectInstance(Effects.WITHER, 100, 1, false, true),
            new EffectInstance(Effects.LEVITATION, 100, 0, false, true) }),
    PYRO(0.25D, 40F, "Pyro", new int[]
    { 196, 41, 6 }, null), ZESTONIAN(0.25D, 40F, "Zestonian", new int[]
    { 155, 6, 196 }, null), REINFORCED(0.25D, 160F, "Reinforced", new int[]
    { 64, 1, 7 }, null), AGILE(0.6D, 10F, "Agile", new int[]
    { 10, 209, 169 }, null);
    ...
    ItemStack toolForMobClass(int type)
    {
        ...
        { new ItemStack(Items.DIAMOND_SWORD), new ItemStack(Items.BOWL), new ItemStack(Items.BOW),
                new ItemStack(Items.STICK), new ItemStack(Items.FLINT_AND_STEEL), new ItemStack(Items.OAK_SIGN),
