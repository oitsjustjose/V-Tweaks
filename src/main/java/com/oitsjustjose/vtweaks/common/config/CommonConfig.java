...
public class CommonConfig {
    ...
    public static final ModConfigSpec.BooleanValue EnableItemNostackMixin;
    ...
    static {
        ...
        EnableItemNostackMixin = BUILDER.comment("If enabled, items entities will no longer stack together like Minecraft Beta").gameRestart().define("enableNonStackingItemTweak", false);
        BUILDER.pop();
