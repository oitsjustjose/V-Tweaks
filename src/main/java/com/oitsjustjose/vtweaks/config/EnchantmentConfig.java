...
public class EnchantmentConfig
{
        ...
        public static void init(ForgeConfigSpec.Builder COMMON_BUILDER)
        {
                ...
                ENABLE_LUMBERING = COMMON_BUILDER.comment("Enable the Lumbering enchantment for Axes")
                                .define("enableLumbering", true);
                ENABLE_IMPERISHABLE = COMMON_BUILDER
                                .comment("Enable the Imperishable enchantment for any breakable item")
                                .define("enableImperishable", true);
                ENABLE_FF_TWEAK = COMMON_BUILDER
                                .comment("Feather Falling IV or above directs 100% of fall damage to boots")
                                .define("enableFeatherFallTweak", true);
                IMPERISHABLE_RECIPE_COST = COMMON_BUILDER
                                .comment("Number of levels Imperishable costs to create in an anvil")
