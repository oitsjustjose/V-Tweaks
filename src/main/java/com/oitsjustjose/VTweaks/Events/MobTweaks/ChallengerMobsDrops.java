...
public class ChallengerMobsDrops
{
	...
	EntityItem getItem(World world, double x, double y, double z)
	{
		...
		{
		case 0:drop = new ItemStack(Items.gold_ingot, rand.nextInt(3) + 1);
		break;
		case 1:drop = new ItemStack(Items.gold_nugget, rand.nextInt(9) + 10);
		break;
		case 2:drop = new ItemStack(Items.diamond);
		break;
		case 3:drop = new ItemStack(Items.emerald);
		break;
		}
	...
	EntityItem getEnchantedBook(World world, double x, double y, double z)
	{
		...
		{
		case 0:Items.enchanted_book.addEnchantment(book, new EnchantmentData(Enchantment.sharpness, rand.nextInt(5) + 1));
		break;
		case 1:Items.enchanted_book.addEnchantment(book, new EnchantmentData(Enchantment.fortune, rand.nextInt(3) + 1));
		break;
		case 2:Items.enchanted_book.addEnchantment(book, new EnchantmentData(Enchantment.baneOfArthropods, rand.nextInt(4) + 1));
		break;
		case 3:Items.enchanted_book.addEnchantment(book, new EnchantmentData(Enchantment.thorns, rand.nextInt(4) + 1));
		break;
		case 4:Items.enchanted_book.addEnchantment(book, new EnchantmentData(Enchantment.efficiency, rand.nextInt(5) + 1));
		break;
		case 5:Items.enchanted_book.addEnchantment(book, new EnchantmentData(Enchantment.looting, rand.nextInt(3) + 1));
		break;
		case 6:Items.enchanted_book.addEnchantment(book, new EnchantmentData(Enchantment.protection, rand.nextInt(5) + 1));
		break;
		case 7:Items.enchanted_book.addEnchantment(book, new EnchantmentData(Enchantment.unbreaking, rand.nextInt(3) + 1));
		break;
		case 8:Items.enchanted_book.addEnchantment(book, new EnchantmentData(Enchantment.featherFalling, rand.nextInt(4) + 1));
		break;
		case 9:Items.enchanted_book.addEnchantment(book, new EnchantmentData(Enchantment.infinity, 1));
		break;
		case 10:Items.enchanted_book.addEnchantment(book, new EnchantmentData(Enchantment.power, rand.nextInt(5) + 1));
		break;
		}
